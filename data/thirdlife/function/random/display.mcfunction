...
# Called by: thirdlife:random/roll
# Entity @s: Player
#
...
# Final roll
#
execute if score #rolls rolls matches 0 if score @s rolls matches 4.. run title @s title [{score:{name:"@s",objective:"rolls"},color:"dark_green"},{text:" Lives",color:"yellow"}]
execute if score #rolls rolls matches 0 if score @s rolls matches 3 run title @s title [{score:{name:"@s",objective:"rolls"},color:"green"},{text:" Lives",color:"yellow"}]
execute if score #rolls rolls matches 0 if score @s rolls matches 2 run title @s title [{score:{name:"@s",objective:"rolls"},color:"yellow"},{text:" Lives",color:"yellow"}]
