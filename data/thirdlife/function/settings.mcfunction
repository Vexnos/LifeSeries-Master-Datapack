...
tellraw @s [{text:"Worldborder Size: ",color:"gray"},{text:"500","color":"green",click_event:{action:"run_command",command:"/worldborder set 500"}},{text:" | ",color:"gray"},{text:"700",color:"green",click_event:{action:"run_command",command:"/worldborder set 700"}},{text:" | ",color:"gray"},{text:"1000",color:"green",click_event:{action:"run_command",command:"/worldborder set 1000"}}]
tellraw @s {text:"----------------------",color:"gray"}