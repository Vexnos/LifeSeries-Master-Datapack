...
tellraw @a[tag=admin] {text:"Limited Life",color:"red",hover_event:{action:"show_text",value:{text:"24 Hours to Live, Boogeyman",color:"red"}},click_event:{action:"run_command",command:"/execute as @s run function thirdlife:config/limitedlife"}}
tellraw @a[tag=admin] {text:"----------------------",color:"gray"}