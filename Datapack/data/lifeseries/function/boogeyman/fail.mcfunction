#
# Description: Drop Boogeymen to Red who haven't killed a player
# Called by: lifeseries:main
# Entity @s: Player
#
# Titles and Sound
#
execute as @a[tag=boogeyman] at @s run playsound lifeseries:boogeyman_fail master @s
...
#
# Drop Boogeyman to Red according to the gamemode and remove tag
#
